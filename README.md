...
本リポジトリの内容は [GNU 一般公衆ライセンス v3.0 (GPL v3)](https://www.gnu.org/licenses/gpl-3.0.html) の下で提供されています。
...
The contents of this repository are provided under the [GNU General Public License v3.0 (GPL v3)](https://www.gnu.org/licenses/gpl-3.0.html).
...
本仓库内容采用 [GNU 通用公共许可证 v3.0 (GPL v3)](https://www.gnu.org/licenses/gpl-3.0.html) 许可证授权。
...
본 리포지토리의 내용은 [GNU 일반 공중 사용 허가서 v3.0 (GPL v3)](https://www.gnu.org/licenses/gpl-3.0.html) 라이선스 하에 제공됩니다.
